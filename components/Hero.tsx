...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      className="relative flex w-full min-h-[calc(100svh-2rem)] items-center justify-center overflow-hidden pb-16 pt-28 md:pb-24 md:pt-32"
    >
        ...
        <AnimatePresence mode="wait">
          {!showContact ? (
            <motion.div
              ...
              className="flex max-w-[92vw] flex-col items-center justify-center md:max-w-3xl lg:max-w-4xl"
            >
              ...
              <p className="mt-4 text-center text-base leading-relaxed text-white-100 md:max-w-2xl md:text-lg">
                Hi, I&apos;m Frank. I turn ideas into performant,
            ...
            <motion.div
              ...
              exit={{ opacity: 0, x: 120 }}
              transition={{ duration: 0.4, ease: [0.4, 0, 0.2, 1] }}
              className="flex max-w-[92vw] justify-center md:max-w-2xl"
            >
